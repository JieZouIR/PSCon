...
def build_state_tensor(context, state, state_tensor, tokenizer):
    ...
    output_file_path = os.path.join(current_directory, "state.txt")
    ...
    for s in state:
        ...
        with open(output_file_path, "a") as file:
            file.write(f"exact_match_index:{exact_match_index}\n")
            file.write(f"fuzzy_match_index:{fuzzy_match_index}\n")
    with open(output_file_path, "a") as file:
        file.write(f"state_tensor:{state_tensor}\n")
